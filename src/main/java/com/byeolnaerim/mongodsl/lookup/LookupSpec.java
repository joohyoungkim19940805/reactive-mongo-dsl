...
public final class LookupSpec {
    ...
    public static final class Builder {
        ...
        public Builder outerStage(Bson stage) {
            if (stage != null) {
        ...
        public Builder outerStages(Collection<? extends Bson> stages) {
            if (stages != null) {
        ...
        public Builder outerMatchExpr(Document expr) {
            if (expr != null) {
                outerStages.add(new Document("$match", new Document("$expr", expr)));
            }
            return this;
        }
        ...
        public Builder localField(String localField) {
            spec.localField = MongoFieldNameSupport.toMongoField(localField);
            return this;
        }

        public Builder foreignField(String foreignField) {
            spec.foreignField = MongoFieldNameSupport.toMongoField(foreignField);
            return this;
        }

        public Builder bindConditionFields(String leftFieldPath, Condition cond, String rightFieldPath) {
            String var = nextVar();
        ...
        public Builder bindConditionConst(Object constValue, Condition cond, String rightFieldPath) {
        ...
        public Builder bindConditionBetween(Object lowInclusive, Object highInclusive, String rightFieldPath) {
            whereExprs.add(
                new Document(
                    "$and",
                    List.of(
        ...
        public Builder bindConditionLike(
            String pattern,
            String rightFieldPath,
            Condition.LikeOperator options
        ) {
        ...
        public Builder bindConditionExists(String rightFieldPath, boolean exists) {
            whereExprs.add(existsExpr(MongoFieldNameSupport.toMongoField(rightFieldPath), exists));
            return this;
        }

        public Builder bindConditionIsNull(String rightFieldPath) {
            whereExprs.add(binary("$eq", "$" + MongoFieldNameSupport.toMongoField(rightFieldPath), null));
            return this;
        }

        public Builder bindConditionIsNotNull(String rightFieldPath) {
        ...
        public Builder rawStage(Bson stage) {
            if (stage != null) {
                pipeline.add(stage);
            }
            return this;
        ...
        public Builder unwind(boolean preserveNullAndEmptyArrays) {
            spec.unwind = true;
        ...
        /** Appends a MongoDB driver sort definition, e.g. {@code Sorts.descending("createdAt")}. */
        public Builder sort(Bson sortDefinition) {
            if (sortDefinition != null) {
                pipeline.add(Aggregates.sort(sortDefinition));
            }
            return this;
        }
        ...
        private void addConditionExpr(Condition cond, Object leftValueOrConst, String rightFieldPath) {
            ...
            switch (cond) {
                ...
                case in -> {
                    if (!(leftValueOrConst instanceof Collection<?> values)) {
                ...
                case like -> {
                    if (!(leftValueOrConst instanceof String pattern)) {
                        throw new IllegalArgumentException("LIKE requires string pattern");
                    }
                    whereExprs.add(regexMatch(rightField, pattern, Condition.LikeOperator.i));
                }
                case regex -> {
                    if (!(leftValueOrConst instanceof String pattern)) {
                        throw new IllegalArgumentException("REGEX requires pattern string");
                    }
                    whereExprs.add(regexMatch(rightField, pattern, null));
                }
                case exists -> {
                    if (!(leftValueOrConst instanceof Boolean exists)) {
                        throw new IllegalArgumentException("EXISTS requires boolean");
                    }
                    whereExprs.add(existsExpr(MongoFieldNameSupport.toMongoField(rightFieldPath), exists));
                }
                ...
                case all -> {
                    if (!(leftValueOrConst instanceof Collection<?> values)) {
                        throw new IllegalArgumentException("ALL requires a collection");
                    }
                    whereExprs.add(new Document("$setIsSubset", List.of(values, right)));
                }
                case between -> {
                    if (!(leftValueOrConst instanceof Collection<?> values) || values.size() != 2) {
        ...
        private static Document binary(String operator, Object left, Object right) {
        ...
        private static Document existsExpr(String rightFieldPath, boolean exists) {
